...
class TrainingsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create training" do
    assert_difference("Training.count") do
      post trainings_url, params: { training: { category: @training.category, description: @training.description, main_instructor: @training.main_instructor, start_date: @training.start_date, title: @training.title } }
    end
  ...
  test "should update training" do
    patch training_url(@training), params: { training: { category: @training.category, description: @training.description, main_instructor: @training.main_instructor, start_date: @training.start_date, title: @training.title } }
